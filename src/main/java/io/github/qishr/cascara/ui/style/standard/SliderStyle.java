...
public class SliderStyle extends ControlStyle {
    public SliderStyle() {
        ...
        defineRule(newRule()
            ...
            .addDeclaration(FX_BACKGROUND_COLOR, values(TRANSPARENT), false)
            // .addDeclaration(FX_BACKGROUND_COLOR, literal("#ffaa44"), false)

            .addDeclaration(FX_BACKGROUND_INSETS, literal(ZERO), false)
            .addDeclaration(FX_BORDER_WIDTH, literal(ZERO), false)
            // .addDeclaration(FX_BORDER_COLOR, values(VALUE_TRANSPARENT), false)
        ...
        defineRule(newRule()
            ...
            // .addDeclaration(FX_BACKGROUND_INSETS, literal(VALUE_ZERO), false)
            // .addDeclaration(FX_PADDING, literal("1px"), false)
        ...
        defineRule(newRule()
            ...
            .addDeclaration(FX_BACKGROUND_COLOR, values(color(ColorID.FOREGROUND)), false)
